from ..utils.data_preparation_models import prepare_linear_features
from ..utils.data_preparation_models import fit_scaler, transform_with_scaler

def svm_data_loader(df, artifact):
